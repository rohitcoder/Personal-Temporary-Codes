...
var interfaceConfig = {
    ...
    JITSI_WATERMARK_LINK: 'https://edvoid.com',
...
SHOW_WATERMARK_FOR_GUESTS: true, // if watermark is disabled by default, it can be shown only for guests
    ...
    TOOLBAR_BUTTONS: [
        ...
        'fodeviceselection', 'hangup', 'chat','etherpad', 'sharedvideo', 'settings', 'raisehand',
